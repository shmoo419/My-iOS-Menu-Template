...
/*****************************/
static NSString *const title = @"@@HACKNAME@@"; //title of your menu
static NSString *const credits = @"Made by @@USER@@"; //who made the hack?
static NSString *const font = @"AlNile-Bold"; //what font do you want the text to be? don't put anything for the default font
